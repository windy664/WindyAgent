...
private val loopLogger = LoggerFactory.getLogger("org.windy.windyagent.tools.ToolLoop")
...
internal fun toolLoop(
    ...
    sessionId: String = "",
    userMessage: String = "",
    messagesResolver: AgentRuntimeMessages = AgentRuntimeMessages.Default,
            ...
            LLMResponse.StopReason.TOOL_USE -> {
                ...
                if (failureDetector != null) {
                    ...
                    if (fdState == FailureDetector.Verdict.TOO_MANY_CALLS) {
                        val msg = messagesResolver.t("tools.too_many_calls", failureDetector.callCount())
                ...
                val msg = messagesResolver.t("tools.stopped", response.stopReason ?: "")
                trajectory?.finish(msg, false)
                return AgentResponse(msg, false, executedTools)
            }
        }
    ...
    val msg = messagesResolver.t("tools.max_iter", maxIterations)
    trajectory?.finish(msg, false)
    return AgentResponse(msg, false, executedTools)
}
