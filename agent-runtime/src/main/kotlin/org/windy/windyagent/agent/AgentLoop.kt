...
internal fun toolLoop(
            ...
            LLMResponse.StopReason.TOOL_USE -> {
                ...
                if (failureDetector != null) {
                    ...
                    if (fdState == FailureDetector.Verdict.TOO_MANY_CALLS) {
                        val msg = messagesResolver.t("agent.too_many_calls", failureDetector.callCount())
                ...
                val msg = messagesResolver.t("agent.stopped", response.stopReason ?: "")
                trajectory?.finish(msg, false)
                return AgentResponse(msg, false, executedTools)
            }
        }
    ...
    val msg = messagesResolver.t("agent.max_iter", maxIterations)
    trajectory?.finish(msg, false)
    return AgentResponse(msg, false, executedTools)
}
